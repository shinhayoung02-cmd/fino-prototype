...
export default function ParcelStoreDeliveryComplete({ onFinishSearch, onKeepAndGoHome, itemProfile = ITEM_PROFILES['wallet-normal'] }) {
    ...
    <div className="parcel-store-delivery-complete">
      ...
      <div className="parcel-store-delivery-complete__progress">
        {PROGRESS_STEPS.map((label, index) => (
          <div className="parcel-store-delivery-complete__progress-step" key={label}>
            {index > 0 && (
              <div
                className={`parcel-store-delivery-complete__progress-connector parcel-store-delivery-complete__progress-connector--done${
                  index === PROGRESS_STEPS.length - 1 ? ' parcel-store-delivery-complete__progress-connector--latest' : ''
                }`}
              />
            )}
            <div className="parcel-store-delivery-complete__progress-node">
              <img
                ...
                alt=""
                className={`parcel-store-delivery-complete__progress-circle${
                  index === PROGRESS_STEPS.length - 1 ? ' parcel-store-delivery-complete__progress-circle--latest' : ''
                }`}
              />
      ...
      <div className="parcel-store-delivery-complete__item-card">
        ...
        <div className="parcel-store-delivery-complete__item-info">
          <p className="parcel-store-delivery-complete__item-title">{itemProfile.category} 습득</p>
