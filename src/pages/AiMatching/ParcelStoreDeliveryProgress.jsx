...
export default function ParcelStoreDeliveryProgress({ itemProfile = ITEM_PROFILES['wallet-normal'] } = {}) {
    ...
    <div className="parcel-store-progress">
              ...
              <div
                className={`parcel-store-progress__progress-connector${
                  step.done && PROGRESS_STEPS[index - 1].done
                    ...
                    : ''
                }${index === LAST_DONE_INDEX ? ' parcel-store-progress__progress-connector--latest' : ''}`}
              />
            )}
            <div className="parcel-store-progress__progress-node">
              {step.done ? (
                <img
                  ...
                  alt=""
                  className={`parcel-store-progress__progress-circle${
                    index === LAST_DONE_INDEX ? ' parcel-store-progress__progress-circle--latest' : ''
                  }`}
                />
              ) : (
      ...
      <div className="parcel-store-progress__item-card">
        ...
        <div className="parcel-store-progress__item-info">
          <p className="parcel-store-progress__item-title">{itemProfile.category} 습득</p>
